...
namespace SimplesWindowsFormsBanco
{
    public class Banco
    {
        private string stringConexao = "Data Source=Notebook\\SQLExpress; Initial Catalog=ATOSUFN;TrustServerCertificate=True;Integrated security = True; language=Portuguese";
